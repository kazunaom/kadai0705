...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO mono_story(id, name, brand, price, tag,
indate, image  )VALUES(NULL, :a1, :a2, :a3,:a4, sysdate(), :image)");
$stmt->bindValue(':a1', $name,   PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':a2', $brand,  PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':a3', $price,  PDO::PARAM_STR); 
$stmt->bindValue(':a4', $tag, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
